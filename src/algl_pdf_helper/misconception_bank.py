...
COMMON_MISCONCEPTIONS: list[MisconceptionPattern] = [
    ...
    MisconceptionPattern(
        ...
        likely_prereq_failure="sql-intro",
    ...
    MisconceptionPattern(
        ...
        likely_prereq_failure="subqueries",
...
ERROR_SUBTYPE_TO_CONCEPT: dict[str, str] = {
    ...
    "missing_join_condition": "joins",
    "incorrect_join_type": "joins",
    "missing_group_by": "group-by",
    "having_without_group_by": "having",
    "where_having_confusion": "having",
    "incorrect_aggregate_function": "aggregate-functions",
    "ambiguous_column_reference": "joins",
    "missing_table_alias": "joins",
    "subquery_multiple_rows": "subqueries",
